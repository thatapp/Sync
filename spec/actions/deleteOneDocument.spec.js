...
const { process } = require('../../lib/actions/deleteOneDocument');
...
describe('"Delete One Document" action test', () => {
  describe('succeed', () => {
    let execRequest;
    beforeEach(() => {
    ...
    it('process', async () => {
      ...
      expect(execRequest.getCall(0).args).to.be.deep.eq(['deleteOne', { filter: body.condition }, { body }]);
    });
  });
  describe('fail', () => {
    beforeEach(() => {
