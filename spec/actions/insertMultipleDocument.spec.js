...
const { process } = require('../../lib/actions/insertMultipleDocument');
...
describe('"Insert multiple Document" action test', () => {
  describe('succeed', () => {
    let execRequest;
    beforeEach(() => {
    ...
    it('process', async () => {
      ...
      expect(execRequest.getCall(0).args).to.be.deep.eq(['insertMany', { document: body.save_data }, { body }]);
    });
  });
  describe('fail', () => {
    beforeEach(() => {
