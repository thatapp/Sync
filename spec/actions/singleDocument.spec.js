...
const { process } = require('../../lib/actions/singleDocument');
...
describe('"Find a Single Document" action test', () => {
  describe('succeed', () => {
    let execRequest;
    beforeEach(() => {
    ...
    it('process', async () => {
      ...
      expect(execRequest.getCall(0).args).to.be.deep.eq(['findOne', { filter: body.condition }, { body }]);
    });
  });
  describe('fail', () => {
    beforeEach(() => {
